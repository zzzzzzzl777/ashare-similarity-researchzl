# 14:57 Next-Round Output Audit (20260513_stage2_top4fold)

- Created at: 2026-05-13T02:30:00.586540+00:00
...
| P1 | fixed_matrix_variant_coverage | WIP | Variants 1/3. |
| P1 | fixed_matrix_scheme_coverage | WIP | Schemes 1/4. |

## Leaderboard Preview

| variant | scheme | folds | mean_wilson_95 | min_wilson_95 | mean_accuracy | candidates | p0 |
|---|---:|---:|---:|---:|---:|---:|---:|
| pre_new_A_engineerable_control | expanding_from_fair_start | 3 | 0.789340 | 0.727967 | 0.811142 | 4610 | 0 |
