...
|------|-------|
| Pipeline status | ok |
| Output grade | postclose_full_data |
| Asof time | 2026-05-15 15:26:45 |
| Within 180s | NO |
| Universe | 1135 stocks |
| Scored | 916 |
| Above threshold (0.5300) | 909 |
| Candidates (tradable+threshold) | 897 |
| Top probability | 0.8387 |
...
| Turnover | 0.3 |
| Inject bar | 0.76 |
| Symbol features | 57.3 |
| Factors attach | 18.3 |
| Tushare T-1 | 0.0 |
| Realtime override | 0.51 |
...
| C004 selected | False |
| C009 selected | False |
| Live total seconds | 1535.68 |
| Within 180 seconds | False |
| Top probability | 0.8387096524238586 |
...
| Count | 8 |
| Top probability | 0.83870965 |
| Min probability | 0.8193431 |
| Selector CSV | `C:\Users\zzzzzzl\Desktop\realtime_1457_outputs\realtime_1457_m1457_selector_top6_20260515_152556.csv` |
| Full CSV | `C:\Users\zzzzzzl\Desktop\realtime_1457_outputs\realtime_1457_m1457_full_20260515_152556.csv` |
