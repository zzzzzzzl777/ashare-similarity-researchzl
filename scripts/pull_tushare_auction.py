"""Tushare P0 - 开盘/收盘集合竞价 stk_auction_o + stk_auction_c，按交易日拉取
注意：stk_auction（汇总版）历史覆盖不稳定，只拉 _o 和 _c
"""
...
if __name__ == '__main__':
    pull_api('stk_auction_o', pro.stk_auction_o)
    pull_api('stk_auction_c', pro.stk_auction_c)
