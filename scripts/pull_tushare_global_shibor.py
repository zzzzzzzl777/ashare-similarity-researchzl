"""Tushare P3 - 全球指数 index_global + SHIBOR利率 shibor，按交易日拉取"""
...
def pull_api(api_name, api_func, date_param='trade_date'):
...
if __name__ == '__main__':
    pull_api('index_global', pro.index_global)
    pull_api('shibor', pro.shibor, date_param='date')
